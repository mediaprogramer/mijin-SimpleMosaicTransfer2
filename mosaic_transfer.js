...
//    console.log(ua2hex(serializedQuantity), serializedMosaicId, serializedQuantity);
...
function serializeTransferTransaction (entity) {
	...
	var d = new Uint32Array(r); // 4byte
	var b = new Uint8Array(r); // 1byte
	d[0] = entity['type'];
	d[1] = entity['version'];
...
//	}
	...
	var URL ="http://" +  URLS[randnum] + ":7895/transaction/announce";
	console.log(URL);
	return $.ajax({
		url: URL ,
		type: 'POST',
